...
: ${AMENT_CURRENT_PREFIX:="/home/nathan/dronut/install/joy_test"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/joy_test/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/joy_test/environment/path.sh"
